...
const FloatingIcons = () => {
  ...
  // Configured phone & WhatsApp numbers
  const callNumber = '+919556355446';
  const whatsappNumber = '919556355446'; 
  ...
  return (
    <aside className="FloatingIcons" aria-label="Floating quick actions">
      ...
      {/* Direct Call Button with updated number */}
      <a
        href={`tel:${callNumber}`}
        className="FloatingIcons__btn FloatingIcons__btn--call"
        aria-label="Call +91 9556355446"
      >
      ...
      <a
        ...
        aria-label="Chat on WhatsApp +91 9556355446"
      >
        <svg className="FloatingIcons__svg" viewBox="0 0 24 24" fill="currentColor">
