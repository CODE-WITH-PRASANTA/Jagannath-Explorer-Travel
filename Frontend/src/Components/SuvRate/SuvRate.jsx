...
const TariffBanner = () => {
  return (
    <div className="suv-rate-banner">
      <span
        className="suv-rate-banner__shine"
        aria-hidden="true"
      />

      <span
        className="suv-rate-banner__icon"
        aria-hidden="true"
      >
        ✨
      </span>
...
const TariffRow = ({ row, index }) => {
  ...
  return (
    <tr
      ref={reveal}
      className={`suv-rate-row reveal${
        row.featured ? " suv-rate-row--featured" : ""
      }`}
      style={{ "--stagger": index }}
    >
      <th
        scope="row"
        className="suv-rate-row__vehicle"
      >
        ...
        {row.featured && (
          <span className="suv-rate-row__badge">
            Top Choice
          </span>
        )}
      </th>
  ...
  return (
    <div className="suv-rate-table-card">
      ...
      <div className="suv-rate-table-wrap">
        <div
          ref={scrollRef}
          className={`suv-rate-scroll${
            scrolled ? " suv-rate-scroll--scrolled" : ""
          }`}
        >
          <table className="suv-rate-table">
            <caption className="sr-only">
              SUV rental tariff and charges for Jagannath Explorer Travels in Bhubaneswar
            </caption>
        ...
        <span
          className={`suv-rate-table-wrap__hint${
            scrolled ? " is-hidden" : ""
          }`}
          aria-hidden="true"
        >
...
const TermItem = ({ text, index }) => {
  ...
  return (
    <li
      ref={reveal}
      className="suv-term-item reveal"
      style={{ "--stagger": index }}
    >
      ...
      <span className="suv-term-item__text">
        {text}
      </span>
    </li>
  );
  ...
  return (
    <div className="suv-terms-card">
      <div className="suv-terms-card__header">
        <div
          className="suv-terms-card__badge-icon"
          aria-hidden="true"
        >
          🛡️
        </div>
        ...
        <div>
          <span className="suv-terms-card__small-title">
            Travel with confidence
          </span>

          <h3 className="suv-terms-card__title">
            SUV Rental Terms &amp; Conditions
          </h3>
        </div>
      </div>
...
/* ---------------------------------------------------------------------------
   Main SUV Rate Section
--------------------------------------------------------------------------- */

const SuvRate = () => {
  return (
    <section
      className="suv-rate-section"
      aria-labelledby="suv-rate-heading"
    >
      <div
        className="suv-rate-section__bg"
        aria-hidden="true"
      />

      <header className="suv-rate-section__header">
        <span className="suv-rate-section__eyebrow">
          SUV Rates &amp; Charges
        </span>

        <h1
          id="suv-rate-heading"
          className="suv-rate-section__title"
        >
        ...
        <p className="suv-rate-section__subtitle">
          ...
          <strong>Jagannath Explorer Travels</strong>, a
          reliable travel service provider offering comfortable
          SUV rentals and well-planned travel options in
          Bhubaneswar and across Odisha.
        </p>

        <p className="suv-rate-section__description">
          Whether you are planning a family holiday, local
          sightseeing, an airport transfer, a business trip or
          an outstation journey, our range of SUVs gives you
          practical options for different group sizes and travel
          needs. Our{" "}
          <strong>
            Bhubaneswar travel agency tour packages
          </strong>{" "}
          can also be combined with suitable vehicle options to
          make your complete trip easier to plan.
        </p>

        <div className="suv-rate-business">
          <div className="suv-rate-business__item">
            <span className="suv-rate-business__icon">
              📍
            </span>
          ...
          <div className="suv-rate-business__item">
            ...
            <div>
              <strong>Call for SUV Booking</strong>
              <span>
                9668892441&nbsp;&nbsp;|&nbsp;&nbsp;9556355446
              </span>
            </div>
          </div>
        </div>
