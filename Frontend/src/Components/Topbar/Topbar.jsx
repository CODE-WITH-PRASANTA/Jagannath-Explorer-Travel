    ...
    <header className="topbar">
      <div className="topbar-container">
        ...
        >
          ...
          <span className="topbar-text">{address}</span>
        </a>

        {/* Contact Numbers */}
        <div className="topbar-contacts">
          {/* Phone 1 */}
          <a href="tel:+919668892441" className="topbar-contact">
            ...
            <span>(+91) 9668892441</span>
          </a>

          <span className="topbar-divider" aria-hidden="true"></span>

          {/* Phone 2 */}
          <a href="tel:+919556355446" className="topbar-contact">
            <span className="topbar-phone-icon" aria-hidden="true">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
